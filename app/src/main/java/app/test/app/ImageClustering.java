...
public class ImageClustering {
    ...
    public static BufferedImage[] createBiomeImages(BufferedImage originalImage, BufferedImage brightenedImage, int[] labels, int nClusters, NormeCouleurs normeCouleurs) {
        ...
        BufferedImage[] biomeImages = new BufferedImage[BIOME_COLORS.length];
        for (int i = 0; i < BIOME_COLORS.length; i++) {
